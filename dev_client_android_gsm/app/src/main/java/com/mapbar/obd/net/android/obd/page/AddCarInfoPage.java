 ...
 */
public class AddCarInfoPage extends AppPage {
    public AddCarInfoPage(Context context, View rootview) {
        super(context, rootview);
    }

    public AddCarInfoPage(Context context, View rootview, AppPage parent) {
