 ...
 */
public class FillInVinPage extends AppPage {
    public FillInVinPage(Context context, View rootview) {
        super(context, rootview);
    }

    public FillInVinPage(Context context, View rootview, AppPage parent) {
