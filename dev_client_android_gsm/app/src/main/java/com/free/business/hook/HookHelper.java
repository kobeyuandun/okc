...
public class HookHelper {
    ...
    public static void hookIActivityManager() {
        ...
        //1.找到hook的点
        //2.hook点，动态代理 静态
        //3.获取getDefault()的IActivityManager的原始对象
        //4.动态代理，准备classloader接口
...
//            }
            try {
                ...
                Object proxy = Proxy.newProxyInstance(contextClassLoader, new Class[]{iActivityManagerInterface}, new InvocationHandler() {
                    @Override
                    public Object invoke(Object o, Method method, Object[] objects) throws Throwable {
                        ...
                        if ("startActivity".equals(method.getName())){
                            ...
                            String stubPackage = "com.example.sqlitetest";
                            newIntent.setComponent(new ComponentName(stubPackage,StubActivity.class.getName()));
                            //把这个newIntent放回到objects中，达到欺骗AMS目的
                            newIntent.putExtra(EXTRA_TARGET_INTENT,raw);
                            objects[index] = newIntent;
                        }
                        return method.invoke(rawIActivityManager,objects);
                    }
                });
                //把代理对象融入到framwork中
